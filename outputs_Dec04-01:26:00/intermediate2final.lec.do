...
# Generated on: Wed Dec 04 01:26:04 EST 2024 (Wed Dec 04 06:26:04 GMT 2024)

set lec_version [regsub {(-).} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file logs_Dec04-01:26:00/intermediate2final.lec.log -replace
...
read_library -liberty -both   /escnfs/courses/fa24-cse-30342.01/dropbox/dmikolay/VLSI/muddlib.lib

read_design -verilog95   -golden -lastmod -noelab fv/controller/fv_map.v.gz
elaborate_design -golden -root {controller}

read_design -verilog95   -revised -lastmod -noelab outputs_Dec04-01:26:00/controller_m.v
