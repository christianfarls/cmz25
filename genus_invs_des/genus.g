...
# Created by Genus(TM) Synthesis Solution 17.24-s038_1 on Wed Dec 04 01:26:04 EST 2024
...
set_db -quiet runtime_by_stage {{PBS_Generic-Start 0 17 0.0 9.0} {to_generic 1 18 0 9} {first_condense 0 18 0 9} {PBS_Generic_Opt-Post 1 18 0.9806860000000004 9.980686} {{PBS_Generic-Postgen HBO Optimizations} 0 18 0.0 9.980686} {PBS_TechMap-Start 0 18 0.0 9.980686} {{PBS_TechMap-Premap HBO Optimizations} 0 18 0.0 9.980686} {second_condense 0 18 0 10} {reify 1 19 0 10} {global_incr_map 0 19 0 10} {{PBS_Techmap-Global Mapping} 1 19 0.9026129999999988 10.883299} {{PBS_TechMap-Datapath Postmap Operations} 0 19 0.0 10.883299} {{PBS_TechMap-Postmap HBO Optimizations} 0 19 0.0 10.883299} {{PBS_TechMap-Postmap Clock Gating} 0 19 0.0 10.883299} {{PBS_TechMap-Postmap Cleanup} 0 19 0.0 10.883299} {PBS_Techmap-Post_MBCI 0 19 0.0 10.883299} {incr_opt 0 20 0 11} }
set_db -quiet tinfo_tstamp_file .rs_dmikolay.tstamp
set_db -quiet metric_enable true
set_db -quiet script_search_path .
set_db -quiet use_area_from_lef true
set_db -quiet hdl_unconnected_marking_done true
set_db -quiet flow_metrics_snapshot_uuid dee0e91f-73ef-407c-b3fa-3fcd7011db7b
...
# END DFT SECTION
set_db -quiet design:controller .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 44158} {cell_count 152} {utilization  0.00} {runtime 1 18 0 9} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 39266} {cell_count 133} {utilization  0.00} {runtime 0 18 0 9} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 38994} {cell_count 131} {utilization  0.00} {runtime 0 18 0 10} }{reify {wns 4699} {tns 0} {vep 0} {area 32140} {cell_count 113} {utilization  0.00} {runtime 1 19 0 10} }{global_incr_map {wns 4699} {tns 0} {vep 0} {area 32140} {cell_count 113} {utilization  0.00} {runtime 0 19 0 10} }{incr_opt {wns 214748365} {tns 0} {vep 0} {area 31687} {cell_count 108} {utilization  0.00} {runtime 0 20 0 11} }}
...
## Written on 01:26:04 04-Dec 2024
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid dee0e91f-73ef-407c-b3fa-3fcd7011db7b}
