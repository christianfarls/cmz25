...
#  Created on Wed Dec  4 01:39:30 2024                
#                                                     
#######################################################
...
puts -nonewline sock7fdd0931bb10 {-2 #verifyGeom}
set_db init_netlist_files outputs_Dec04-01:26:00/controller_m.v
set_db init_lef_files m
set_db init_lef_files mu
set_db init_lef_files mud
set_db init_lef_files mudd
set_db init_lef_files muddl
set_db init_lef_files muddli
set_db init_lef_files muddlib
set_db init_lef_files muddlib.
set_db init_lef_files muddlib.l
set_db init_lef_files muddlib.le
...
read_netlist outputs_Dec04-01:26:00/controller_m.v -top controller
set_current_design controller
init_design
...
gui_select -point {314.450 268.500}
...
set_db flow_schedule {}
set_db flow_metrics_snapshot_uuid 334ed559
set_db flow_metrics_snapshot_uuid 334ed559
eval_legacy { is_attribute metric_current_run_id -obj_type root }
eval_legacy { is_attribute metric_advanced_url_endpoint -obj_type root }
eval_legacy { is_attribute metric_current_run_id -obj_type root }
...
set_db flow_schedule {}
set_db flow_schedule {}
set_db flow_metrics_snapshot_uuid 334ed566
set_db flow_metrics_snapshot_uuid 334ed566
get_proto_model -type_match {flex_module flex_instgroup} -committed -name -tcl
place_fix_congestion
puts {***** Total cpu  0:0:0}
...
set_db flow_schedule {}
set_db flow_schedule {}
set_db flow_metrics_snapshot_uuid 334ed55a
set_db flow_metrics_snapshot_uuid 334ed55a
...
set_db flow_schedule {}
set_db flow_schedule {}
set_db flow_metrics_snapshot_uuid 334ed71b
set_db flow_metrics_snapshot_uuid 334ed71b
gui_set_draw_view place
gui_select -point {312.990 247.980}
get_multi_cpu_usage -local_cpu
...
reset_db route_design_detail_post_route_spread_wire
gui_select -point {269.030 264.590}
